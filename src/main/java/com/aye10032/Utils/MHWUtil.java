...
public class MHWUtil {
    ...
    public MHWUtil() {
        ...
        monsterList.add("迅龙");
        monsterList.add("轰龙");
        monsterList.add("霜翼风漂龙");
        monsterList.add("硫斩龙");
        monsterList.add("冰咒龙");
        monsterList.add("雾瘴尸套龙");
        monsterList.add("惶怒恐暴龙");
        monsterList.add("天地煌啼龙");
        monsterList.add("黑狼鸟");
        monsterList.add("黑轰龙");
        monsterList.add("银火龙");
        monsterList.add("猛牛龙");
        ...
        monsterList.add("雷颚龙");
        monsterList.add("凶爪龙");
        monsterList.add("红莲爆鳞龙");
        monsterList.add("溟波龙");
        monsterList.add("歼世灭尽龙");
        monsterList.add("雷狼龙");
        monsterList.add("金火龙");
        monsterList.add("狱狼龙");
        monsterList.add("金狮子");
        monsterList.add("萌宝碎龙");
        monsterList.add("激昂金狮子");
        monsterList.add("冰原渣渣灰");
        monsterList.add("战痕黑狼鸟");
        monsterList.add("冥赤龙");
